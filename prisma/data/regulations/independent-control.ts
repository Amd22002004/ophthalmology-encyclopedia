...
const URLS = {
  ...
  law181: "https://pravo.gov.ru/proxy/ips/?docbody&nd=102038362",
...
export const INDEPENDENT_CONTROL_REGULATIONS: RegulationSeed[] = [
  ...
  act({
    ...
    officialPublicationUrl: URLS.law181,
    legalStatus: "IN_FORCE",
    effectiveFrom: "1995-11-24",
    topicSlugs: ["healthcare-accessibility"],
    sources: [source("Официальный сводный текст Федерального закона № 181-ФЗ", URLS.law181, "consolidated-2026-08-13", 0, "OFFICIAL_CONSOLIDATED_TEXT")],
    editions: [edition({
      key: "consolidated-2026-08-13",
      title: "Сводный текст, проверенный на 13.08.2026",
      effectiveFrom: "1995-11-24",
      legalStatus: "IN_FORCE",
      transitionNote: "Для исторического события требуется редакция статьи 15, действовавшая в его дату.",
      officialTextUrl: URLS.law181,
      verifiedAt: VERIFIED_AT,
      historicalUseAllowed: false,
      verificationNote: "Проверен официальный сводный источник; ретроспективное применение без архивной редакции запрещено.",
      provisions: [publicProvision({
        ...
        applicability: "К конкретному объекту, услуге, категории ограничений и периоду с учётом отраслевого порядка и допустимых альтернатив.",
