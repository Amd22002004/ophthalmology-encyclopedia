...
// @ts-nocheck 
/*
 * This file exports the `HistoryEntry` model and its related types.
 *
...
export type GetHistoryEntryAggregateType<T extends HistoryEntryAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateHistoryEntry[P]>
    : Prisma.GetScalarType<T[P], AggregateHistoryEntry[P]>
}
...
export type GetHistoryEntryGroupByPayload<T extends HistoryEntryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<HistoryEntryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof HistoryEntryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], HistoryEntryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], HistoryEntryGroupByOutputType[P]>
      }
    >
  >
...
export type HistoryEntryWhereInput = {
  ...
  slug?: Prisma.StringFilter<"HistoryEntry"> | string
  title?: Prisma.StringFilter<"HistoryEntry"> | string
  summary?: Prisma.StringNullableFilter<"HistoryEntry"> | string | null
  content?: Prisma.StringNullableFilter<"HistoryEntry"> | string | null
  period?: Prisma.StringNullableFilter<"HistoryEntry"> | string | null
  sourceUrl?: Prisma.StringNullableFilter<"HistoryEntry"> | string | null
  createdAt?: Prisma.DateTimeFilter<"HistoryEntry"> | Date | string
  updatedAt?: Prisma.DateTimeFilter<"HistoryEntry"> | Date | string
}
...
export type HistoryEntryScalarWhereWithAggregatesInput = {
  ...
  slug?: Prisma.StringWithAggregatesFilter<"HistoryEntry"> | string
  title?: Prisma.StringWithAggregatesFilter<"HistoryEntry"> | string
  summary?: Prisma.StringNullableWithAggregatesFilter<"HistoryEntry"> | string | null
  content?: Prisma.StringNullableWithAggregatesFilter<"HistoryEntry"> | string | null
  period?: Prisma.StringNullableWithAggregatesFilter<"HistoryEntry"> | string | null
  sourceUrl?: Prisma.StringNullableWithAggregatesFilter<"HistoryEntry"> | string | null
  createdAt?: Prisma.DateTimeWithAggregatesFilter<"HistoryEntry"> | Date | string
  updatedAt?: Prisma.DateTimeWithAggregatesFilter<"HistoryEntry"> | Date | string
}
...
export type HistoryEntryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "slug" | "title" | "summary" | "content" | "period" | "sourceUrl" | "createdAt" | "updatedAt", ExtArgs["result"]["historyEntry"]>
...
export type HistoryEntryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface HistoryEntryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends HistoryEntryCountArgs>(
    args?: Prisma.Subset<T, HistoryEntryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], HistoryEntryCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, HistoryEntryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHistoryEntryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface HistoryEntryFieldRefs {
  ...
  readonly slug: Prisma.FieldRef<"HistoryEntry", 'String'>
  readonly title: Prisma.FieldRef<"HistoryEntry", 'String'>
  readonly summary: Prisma.FieldRef<"HistoryEntry", 'String'>
  readonly content: Prisma.FieldRef<"HistoryEntry", 'String'>
  readonly period: Prisma.FieldRef<"HistoryEntry", 'String'>
  readonly sourceUrl: Prisma.FieldRef<"HistoryEntry", 'String'>
  readonly createdAt: Prisma.FieldRef<"HistoryEntry", 'DateTime'>
  readonly updatedAt: Prisma.FieldRef<"HistoryEntry", 'DateTime'>
}
